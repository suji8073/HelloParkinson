        ...
        <View style={styles.MainView}>
          <ScrollView>
            <Text style={styles.MText}>
              ...
              관하여 아래와 같이 고지하오니 충분히 읽어보신 후 동의하여 주시기
              바랍니다.{"\n"}
              {"\n"}
              1. 수집 및 이용목적{"\n"}
              {"\n"}
              ...
              {"\n"}
              ·APP에 마련된 회원가입란 및 보험계약 정보 입력란에 회원 본인이
              직접 입력하는 방식{"\n"}
              {"\n"}
              ·생성정보 수집 툴을 통한 수집{"\n"}
              {"\n"}
              4. 보유 및 이용기간{"\n"}
              {"\n"}
              이용자가 회원탈회를 요청하거나 개인정보의 수집·이용 등에 대한
              동의를 철회할 때까지 보유·이용합니다. 다만, 다음의 정보에 대해서는
              아래의 이유로 예외로 합니다.{"\n"}
              {"\n"}
              ...
              대통령령으로 정하는 기간동안 로그인하지 아니하는 이용자의
              개인정보를 보호하기 위하여 개인정보 파기 등 필요한 조치를
              취합니다. APP 회원은 1년간 미로그인시 회원정보 삭제 또는 분리보관
              및 탈퇴 또는 이용정지처리가 됩니다. 이용자의 요청에 따라 달리 정한
              경우가 있을 경우, 달리 정한 기간을 적용할 수 있습니다.
            </Text>
          </ScrollView>
        </View>
